...
- Using the built-in [autosummary](https://www.sphinx-doc.org/en/master/usage/extensions/autosummary.html) extension of Sphinx with the `:recursive:` option
...
- Using the [apidoc](https://www.sphinx-doc.org/en/master/usage/extensions/apidoc.html) extension or [CLI tool](https://www.sphinx-doc.org/en/master/man/sphinx-apidoc.html) built into Sphinx
...
- Using the third-party [AutoAPI](https://sphinx-autoapi.readthedocs.io/en/latest/index.html) extension
...
The semi-automatic approach was chosen as a compromise between the tradeoffs of the above options. The list of modules is not going to change often, so it is acceptable to list them by hand, in exchange for finer control over the table of contents and the layout of each module page, and with minimal dependence on third-party packages.
